          ...
          render={({ field }) => (
            <FormItem>
              <div className="shad-form-item">
                ...
                <FormControl>
                <Input placeholder="Enter you full name" className="shad-input" {...field} autoComplete="off" />
                </FormControl>
              </div>
          ...
          render={({ field }) => (
            <FormItem>
              <div className="shad-form-item">
                ...
                <FormControl>
                <Input placeholder="Enter you email" className="shad-input" {...field} autoComplete="off"/>
                </FormControl>
              </div>
